                ...
                <div className="row">
                    ...
                    <div className="col-lg-6 col-md-6 col-12" style={signUp} id='signUp'>
                        ...
                        <div className="input_container my-4">
                            ...
                            <input placeholder="Full name" title="Inpit title" name="fullname" type="text" className="input_field" id="fullname_field"/>
                        </div>
                        <div className="input_container my-4">
                            ...
                            <input placeholder="Password" name="password" type="password" className="input_field" id="password_field"/>
                        </div>
