                ...
                <div className="row">
                    ...
                    <div className="col-lg-6 col-md-6 col-12" style={signUp} id='signUp'>
                        ...
                        <div className="input_container my-4">
                            ...
                            <input placeholder="name@mail.com" title="Inpit title" name="email" onChange={formik.handleChange} type="text" className="input_field" id="email_field"/>
                        </div>
                        <div className="input_container my-4">
                            ...
                            <input placeholder="Full name" title="Inpit title" name="fullname" onChange={formik.handleChange} type="text" className="input_field" id="fullname_field"/>
                        </div>
                        <div className="input_container my-4">
                            ...
                            <input placeholder="Password" name="password" onChange={formik.handleChange} type="password" className="input_field" id="password_field"/>
                        </div>
                        ...
                        <div className="separator">
                            <hr className="line"/>
                                ...
                                <button title="Sign In" type="submit" className="sign-in_ggl my-2" onClick={signInG}>
                                    <svg height="18" width="18" viewBox="0 0 32 32" xmlnsXlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <g transhtmlform="matrix(.727273 0 0 .727273 -.954545 -1.45455)">
                                ...
                                <p className="text-center my-2">Have an account? <span><Link style={{color: "#a10035ff"}} to='/signin'>Sign in</Link></span></p>
                        </div>
                </div>
            </div>
        </div>
