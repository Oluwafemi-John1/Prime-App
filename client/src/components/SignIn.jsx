            ...
            <div className="container" style={mainDiv}>
                <div className="row">
                    ...
                    <div className="col-lg-6 col-md-6 col-12" style={signUp} id='signUp'>
                        <h2 className="text-center mt-lg-5 mt-md-3 mt-4 text-decoration-underline" style={{color: "#a10035ff"}}>Welcome Back</h2>
                        {/* htmlForm */}
                        ...
                        <div className="separator">
                            <hr className="line"/>
                                ...
                                <button title="Sign In" type="submit" className="sign-in_ggl my-2">
                                ...
                                <p className="text-center my-2">Don't have an account? <span><Link style={{color: "#a10035ff"}} to='/signup'>Sign up</Link></span></p>
                        </div>
                </div>
            </div>
        </div>
